# Alert Engine Builder Memory

- [Alert Engine Architecture](alert_engine_architecture.md) — AlertEngine wiring + 2026-07-27 pluggable signal-source refactor
- [Alert Rules Schema](alert_rules_schema.md) — Rule schema, storage location, and default rules
- [WebSocket Fan-out Pattern](websocket_fanout.md) — AlertBroadcaster: WS fan-out, user_id tracking, push-fanout hook
